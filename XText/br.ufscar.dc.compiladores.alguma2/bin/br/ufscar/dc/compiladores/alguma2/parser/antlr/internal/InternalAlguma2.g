...
@lexer::header {
package br.ufscar.dc.compiladores.alguma2.parser.antlr.internal;
			...
			(
				...
				lv_declaracoes_2_0=ruleDeclaracao
				{
					...
					add(
						...
						"declaracoes",
						lv_declaracoes_2_0,
						"br.ufscar.dc.compiladores.alguma2.Alguma2.Declaracao");
			...
			(
				...
				lv_algoritmo_5_0=ruleAlgoritmo
				{
					...
					set(
						...
						"algoritmo",
						lv_algoritmo_5_0,
						"br.ufscar.dc.compiladores.alguma2.Alguma2.Algoritmo");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_tipo_2_0=ruleTipoVar
				{
					...
					set(
						...
						"tipo",
						lv_tipo_2_0,
						"br.ufscar.dc.compiladores.alguma2.Alguma2.TipoVar");
					afterParserOrEnumRuleCall();
				}
			)
		)
