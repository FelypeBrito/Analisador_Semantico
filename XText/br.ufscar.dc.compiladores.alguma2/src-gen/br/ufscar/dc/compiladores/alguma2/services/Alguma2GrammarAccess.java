 ...
 */
package br.ufscar.dc.compiladores.alguma2.services;
...
public class Alguma2GrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ProgramaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.alguma2.Alguma2.Programa");
	...
	public class AlgoritmoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.alguma2.Alguma2.Algoritmo");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DeclaracaoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.alguma2.Alguma2.Declaracao");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TipoVarElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "br.ufscar.dc.compiladores.alguma2.Alguma2.TipoVar");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("br.ufscar.dc.compiladores.alguma2.Alguma2".equals(grammar.getName())) {
				return grammar;
			}
