...
import br.ufscar.dc.compiladores.expr.parser.ExpressoesBaseVisitor;
import br.ufscar.dc.compiladores.expr.parser.ExpressoesParser;
import br.ufscar.dc.compiladores.expr.parser.ExpressoesParser.DeclContext;
import br.ufscar.dc.compiladores.expr.parser.ExpressoesParser.TermoContext;
...
public class Calculador extends ExpressoesBaseVisitor<Double> {
    ...
    public Double visitTermo(ExpressoesParser.TermoContext ctx) {
        if (ctx.expParentesis != null) {
            ...
            return Double.valueOf(ctx.constante.getText());
